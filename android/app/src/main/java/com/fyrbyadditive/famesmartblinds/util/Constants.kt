...
object Constants {
    ...
    object BLE {
        ...
        val WIFI_SCAN_TRIGGER_UUID: UUID = UUID.fromString("beb5483e-36e1-4688-b7f5-ea07361b26b0")
        val WIFI_SCAN_RESULTS_UUID: UUID = UUID.fromString("beb5483e-36e1-4688-b7f5-ea07361b26b1")
        ...
        val ALL_CHARACTERISTIC_UUIDS = listOf(
            ...
            WIFI_SCAN_TRIGGER_UUID, WIFI_SCAN_RESULTS_UUID
        )
    }
